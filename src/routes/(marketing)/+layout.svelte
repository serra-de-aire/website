...
<div class="navbar bg-base-100 container mx-auto">
  ...
  <div class="flex-none">
    <ul class="menu menu-horizontal px-1 hidden sm:flex font-bold text-lg">
      <li class="md:mx-4">
        <a href="https://github.com/serra-de-aire" class="border border-primary"
          >★ us on Github</a
        >
      </li>
    ...
    <div class="dropdown dropdown-end sm:hidden">
      ...
      >
        ...
        <li>
          <a
            href="https://github.com/serra-de-aire"
...
<div class="">
  ...
  >
    <nav>
      ...
      <a class="link link-hover my-1" href="https://github.com/serra-de-aire"
        >Github</a
      >
    </nav>
  </footer>
